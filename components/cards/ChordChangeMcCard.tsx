...
import type { ChordChangeMcParams } from "@/lib/cards/types";
...
export function ChordChangeMcCard({
  params,
  onContinue,
}: {
  params: ChordChangeMcParams;
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Chord change</CardTitle>
        <CardDescription>
          Function in the key (Roman numerals in plain English).
        </CardDescription>
      </CardHeader>
