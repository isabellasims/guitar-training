...
const CONNECT_BOX_1_2_PATTERN: ShapePattern = {
  ...
  ascending: [
    { stringIndex: 5, offset: 0, finger: 1, degree: "1" },
    { stringIndex: 5, offset: 3, finger: 3, degree: "b3" },
    { stringIndex: 4, offset: 0, finger: 1, degree: "4" },
    { stringIndex: 4, offset: 2, finger: 3, degree: "5" },
...
export const SHAPES: ShapeDefinition[] = [
  ...
  // ── C·2 ────────────────────────────────────────────────────
  {
    ...
    steps: [
      { stringIndex: 4, fret: 0, degree: "1" },
      { stringIndex: 4, fret: 2, finger: 1, degree: "2" },
      { stringIndex: 4, fret: 3, finger: 2, degree: "b3" },
      { stringIndex: 3, fret: 0, degree: "4" },
      { stringIndex: 3, fret: 2, finger: 1, degree: "5" },
      { stringIndex: 3, fret: 3, finger: 2, degree: "6" },
      { stringIndex: 2, fret: 0, degree: "b7" },
      { stringIndex: 2, fret: 2, finger: 1, degree: "1" },
    ],
    descending: [
      { stringIndex: 2, fret: 2, finger: 1, degree: "1" },
      { stringIndex: 2, fret: 0, degree: "b7" },
