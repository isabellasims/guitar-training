...
export const LEVELS: Level[] = [
  ...
  { id: "A-13", trackId: "A", level: 13, type: "P", name: "Pentatonic with Targets", prerequisiteLevelIds: ["A-12", "C-7"] },
  { id: "A-14", trackId: "A", level: 14, type: "P", name: "Two-Chord Vamp", prerequisiteLevelIds: ["A-13"] },
  { id: "A-15", trackId: "A", level: 15, type: "P", name: "Real Progression", prerequisiteLevelIds: ["A-14", "D-2"] },
  ...
  // Track C — Fretboard & CAGED (revised: major scales first, open → movable → pent → CAGED)
  ...
  { id: "C-7", trackId: "C", level: 7, type: "F", name: "Box 1 — All Chord Tones", prerequisiteLevelIds: ["C-6", "A-5"] },
  ...
  { id: "D-1", trackId: "D", level: 1, type: "F", name: "I-IV-V Recognition", prerequisiteLevelIds: ["A-5"] },
  { id: "D-2", trackId: "D", level: 2, type: "F", name: "+ The vi Chord", prerequisiteLevelIds: ["D-1"] },
  { id: "D-3", trackId: "D", level: 3, type: "P", name: "Real Progressions — Major", prerequisiteLevelIds: ["D-2"] },
  ...
  { id: "E-1", trackId: "E", level: 1, type: "F", name: "Major 2nd", prerequisiteLevelIds: [] },
  { id: "E-2", trackId: "E", level: 2, type: "F", name: "Major 3rd", prerequisiteLevelIds: ["E-1"] },
  { id: "E-3", trackId: "E", level: 3, type: "F", name: "Perfect 4th", prerequisiteLevelIds: ["E-2"] },
  { id: "E-4", trackId: "E", level: 4, type: "F", name: "Minor 3rd", prerequisiteLevelIds: ["E-3"] },
  { id: "E-5", trackId: "E", level: 5, type: "F", name: "Perfect 5th", prerequisiteLevelIds: ["E-4"] },
  { id: "E-6", trackId: "E", level: 6, type: "F", name: "Minor 7th", prerequisiteLevelIds: ["E-5"] },
  { id: "E-7", trackId: "E", level: 7, type: "F", name: "All Above — Descending", prerequisiteLevelIds: ["E-6"] },
  { id: "E-8", trackId: "E", level: 8, type: "P", name: "All Above — Mixed Random", prerequisiteLevelIds: ["E-7"] },
];
